...
def predict():
    ...
    try:
        ...
        return render_template("index.html", error="Enter a valid number")

    # Backend validation: Experience must be >= 1
    if experience < 1:
        return render_template("index.html", error="Experience must be more than 0")
